// https://bitcointalk.org/index.php?topic=181981.0 [ANN] Genesis Block Generator
// https://pastebin.com/nhuuV7y9 - 
// Copyright "Remember remember the 5th of November" 2013
// sudo apt-get update
// sudo apt-get install build-essential libssl-dev
// gcc genesisgen7.c -o genesisgen7 -lcrypto
// genesisgen2 [options] <pubkey> "<timestamp>" <nBits>
...
const uint64_t COIN = 1;
const uint64_t CENT = 1;
...
Transaction *InitTransaction()
{
	...
	transaction->outValue = 10000*COIN;
...
int main(int argc, char *argv[])
{
	...
	//if(generateBlock)
	{
		...
		while(1)
		{
			...
			unsigned int check = *((uint8_t *)(block_hash2 + 31));  // !!!!! 
			unsigned int check2 = *((uint8_t *)(block_hash2 + 30)); // !!!!! 
			unsigned int check3 = *((uint8_t *)(block_hash2 + 29)); // !!!!! 
			unsigned int check4 = *((uint8_t *)(block_hash2 + 28)); // !!!!! 
			if(check == 0 && check2 == 0 && check3 == 0 && check4 <= 127) // 00 00 00 7f
			{
