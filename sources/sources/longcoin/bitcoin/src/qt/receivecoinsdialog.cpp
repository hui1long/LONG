...
void ReceiveCoinsDialog::on_receiveButton_clicked()
{
    ...
    if(ui->reuseAddress->isChecked())
    {
        ...
        if(dlg.exec())
        {
			...
			if(pubkeyhex.isEmpty()) /* If no label provided, use the previously used label */
            {
                pubkeyhex = model->getAddressTableModel()->pubKeyHexForAddress(address);
            }
        } else {
            return;
        }
    ...
    SendCoinsRecipient info(address, pubkeyhex, label,
