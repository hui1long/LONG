...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CBitcoinAddress setaccountDemoAddress;
    {
        ...
        BOOST_CHECK_NO_THROW({ /*Initialize Wallet with an account */
			...
			std::string pubKeyHex = HexStr(account.vchPubKey.begin(), account.vchPubKey.end());
            pwalletMain->SetAddressBook(account.vchPubKey.GetID(), strAccount, pubKeyHex, strPurpose);
