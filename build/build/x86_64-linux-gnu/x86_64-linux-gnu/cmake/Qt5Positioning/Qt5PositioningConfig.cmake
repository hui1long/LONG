...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5Positioning" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Positioning_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::Positioning)
    ...
    set(Qt5Positioning_PRIVATE_INCLUDE_DIRS
        "${_qt5Positioning_install_prefix}/include/qt5/QtPositioning/5.2.1"
        "${_qt5Positioning_install_prefix}/include/qt5/QtPositioning/5.2.1/QtPositioning"
    )
    ...
    _populate_Positioning_target_properties(RELEASE "libQt5Positioning.so.5.2.1" "" )
