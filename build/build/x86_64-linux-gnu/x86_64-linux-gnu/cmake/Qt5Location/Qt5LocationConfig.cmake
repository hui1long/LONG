...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5Location" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Location_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5Location_VERSION_STRING 5.2.1)
...
macro(_populate_Location_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Location_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Location)
    ...
    set(Qt5Location_PRIVATE_INCLUDE_DIRS
        "${_qt5Location_install_prefix}/include/qt5/QtLocation/5.2.1"
        "${_qt5Location_install_prefix}/include/qt5/QtLocation/5.2.1/QtLocation"
    )
    ...
    set(_Qt5Location_MODULE_DEPENDENCIES "Positioning;Core")
    ...
    foreach(_module_dep ${_Qt5Location_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.2.1 ${_Qt5Location_FIND_VERSION_EXACT}
    ...
    set(_Qt5Location_LIB_DEPENDENCIES "Qt5::Positioning;Qt5::Core")
    ...
    _populate_Location_target_properties(RELEASE "libQt5Location.so.5.2.1" "" )
